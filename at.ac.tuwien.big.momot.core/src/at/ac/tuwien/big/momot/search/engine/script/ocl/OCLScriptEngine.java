      ...
      try {
         ...
         for(final Entry<String, Object> e : bindings.entrySet()) {
            ...
            final String typeName = value instanceof DynamicEObjectImpl
                  ...
                  : value instanceof Double ? "Real" : value.getClass().getSimpleName();

            if(typeName.equals(String.class.getSimpleName())) {
               // System.out.println("1" + String.format(ATTRIBUTE_DEFINITION_STRING, name, typeName, value));
               ...
               // System.out.println("2" + String.format(ATTRIBUTE_DEFINITION, name, typeName, value));
         ...
         final boolean ev = toBoolean(helper.getOCL().createQuery(query).evaluate(self));
         // System.out.println("cond: " + script.substring(0, 10) + " -> " + ev + " (" + query + ")");
         return ev;
